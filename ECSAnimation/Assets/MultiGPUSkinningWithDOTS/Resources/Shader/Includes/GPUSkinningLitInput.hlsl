#ifndef UNIVERSAL_GPUSKINNING_LIT_INPUT_INCLUDED
#define UNIVERSAL_GPUSKINNING_LIT_INPUT_INCLUDED
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4 , _FrameData)
    UNITY_DOTS_INSTANCED_PROP(float4 , _ECS_FrameData)
...
// #define _FrameData              UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4  , Metadata_FrameData)
// #define _ECS_FrameData          UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4  , Metadata_ECS_FrameData)
#endif
...
TEXTURE2D(_AnimTex_Runtime);    SAMPLER(sampler_AnimTex_Runtime);
