...
{
    public static class GPUSkinningLitGUI
    {
        ...
        {
            bool opaque = true;
            if (material.HasProperty(GPUSkinningLitProperty.SurfaceType))
                opaque = ((BaseShaderGUI.SurfaceType)material.GetFloat(GPUSkinningLitProperty.SurfaceType) == BaseShaderGUI.SurfaceType.Opaque);
            return opaque;
        }
        ...
        internal static void SetupSpecularWorkflowKeyword(Material material, out bool isSpecularWorkflow)
        {
            ...
            if (material.HasProperty(GPUSkinningLitProperty.SpecularWorkflowMode))
                isSpecularWorkflow = ((WorkflowMode)material.GetFloat(GPUSkinningLitProperty.SpecularWorkflowMode)) == WorkflowMode.Specular;
