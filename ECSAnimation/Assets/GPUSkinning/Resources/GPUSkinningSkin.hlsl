#ifndef GPUSKINNING_SPECULAR_INCLUDE
#define GPUSKINNING_SPECULAR_INCLUDE

#include "Assets/GPUSkinning/Resources/GPUSkinningInclude.hlsl"
//#include "Assets/GPUSkinning/Resources/GPUSkinningSurface.hlsl"
#include "Assets/GPUSkinning/Resources/GPUSkinningSurfaceInput.hlsl"
// struct appdata
// {
...
// };
//
// vertout myURPVert (appdata v) 
// {
//     vertout var = (vertout)0;
//     var.texcoords.xy = TRANSFORM_TEX(v.uv0, _MainTex); // Always source from uv0
//
//     // Skinning
//     {
...
// }
//
// void mySurfSpecular (vertout IN, inout SurfaceOutputStandardSpecular o) {
...
// }
//
// float4 myURPFrag(vertout var)
// {
//     SurfaceOutputStandardSpecular o = (SurfaceOutputStandardSpecular)0;
//     mySurfSpecular(var,o);
//     float4 color;
...
half4 SkinningMetallicSpecGloss(float2 uv, half albedoAlpha)
{
    half4 specGloss;

    #if _SPECULAR_SETUP
    specGloss = SpecularGloss(uv);
    #else
    half2 metallicGloss = MetallicGloss(uv);
    specGloss.rgb = metallicGloss.xxx;//half3(metallicGloss.x,metallicGloss.x,metallicGloss.x);
    specGloss.a = metallicGloss.y;
    #endif
...
void InitializeSkinningLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    half4 albedoAlpha = SampleAlbedoAlpha(uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
    outSurfaceData.alpha = Alpha(albedoAlpha.a, _BaseColor, _Cutoff);

    half4 specGloss = SkinningMetallicSpecGloss(uv, albedoAlpha.a);
...
Varyings LitPassVertex1(Attributes input)
{
...
Varyings LitPassVertex4(Attributes input)
{
    Varyings output = (Varyings)0;
...
half4 LitPassFragment(Varyings input) : SV_Target
{
    ...
    InitializeSkinningLitSurfaceData(input.uv, surfaceData);
