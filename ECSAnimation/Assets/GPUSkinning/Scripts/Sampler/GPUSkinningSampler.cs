...
public class GPUSkinningSampler : MonoBehaviour 
{
    ...
    private Animation samplerAnimation = null;
    ...
    private void Awake()
	{
        samplerAnimation = GetComponent<Animation>();
		animator = GetComponent<Animator>();
        if (animator == null && samplerAnimation == null)
        {
        ...
        if(samplerAnimation != null)
        {
            ...
            samplerAnimation.Stop();
            samplerAnimation.cullingType = AnimationCullingType.AlwaysAnimate;
            InitTransform();
            return;
        }
	}
	...
	private void Update()
	{
        ...
        {
            samplerAnimation.Stop();
            AnimationState animState = samplerAnimation[animClip.name];
            if(animState != null)
            {
                animState.time = time;
                samplerAnimation.Sample();
                samplerAnimation.Play();
            }
        }
